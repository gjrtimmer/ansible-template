...
if [[ ! -f "${DEVCON_DIR}/.bashrc" ]]; then
    ...
    echo "alias ansible-playground='ansible -i /work/.config/hosts.playground.yml'"
    echo "alias ansible-playground-playbook='ansible-playbook -i /work/.config/hosts.playground.yml'"
    echo "alias ansible-pg='ansible -i /work/.config/hosts.playground.yml'"
    echo "alias ansible-pp='ansible-playbook -i /work/.config/hosts.playground.yml'"
fi
